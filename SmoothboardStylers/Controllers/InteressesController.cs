...
namespace SmoothboardStylers.Controllers
{
    ...
    public class InteressesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ContactId,SurfboardId,Behandeld")] Interesse interesse)
        {
            ...
            ViewData["ContactId"] = new SelectList(_context.Contact, "Id", "Email", interesse.ContactId);
            ViewData["SurfboardId"] = new SelectList(_context.Surfboard, "Id", "Naam", interesse.SurfboardId);
            return View(interesse);
        }
